...
class ValidationControllerTest extends WebTestCase
{
    ...
    public function testGetValidation()
    {
        ...
        $this->client->request(
            'GET',
            '/api/validation/'.$validation->getUid(),
        );
    ...
    public function testGetValidationWithoutUid()
    {
        ...
        // without the uid in url path, the request becomes trying to do a GET request at the address /api/validation, which is not allowed
    ...
    public function testGetValidationNotFound()
    {
        $this->client->request(
            'GET',
            '/api/validation/no-record-for-this-uid',
        );
    ...
    //         [],
    //         content: json_encode([
    //             "model" => "https://ignf.github.io/validator-config-gpu/config/cnig_PLUi_2017/files.json",
    //             "srs" => "EPSG:2154",
    //             "keepData" => false
    //         ]),
    //     );
